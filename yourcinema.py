...
class SerialWorker(object):
    def __init__(self):
        ...
        self.descr_xpath = '//div[@class="full-inforam"]/text()'
    ...
    def add_serial_to_db(self, serial_info):
        self.cur.execute('INSERT INTO serials ('
                         ...
                         'description, '
                         'poster_remote, '
                         'poster_local, last_update) VALUES (?,?,?,?,?,?)',
                         (serial_info['url'],
                          serial_info['name'],
                          serial_info['description'],
                          serial_info['poster'],
                          serial_info['l_poster'],
                          serial_info['last_update']))
    ...
    def fill_in_db(self):
        ...
        while True:
            ...
            for serial_card in serial_cards:
                serial_url = serial_card.xpath('.//div[@class="btn-slider"]/a/@href')[0]
